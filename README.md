...
**个人钱包 + 商户收款 + 开放 API + 多平台对账聚合的一体化支付平台**

🚀 版本 2.0.0 | NestJS 11 + Prisma 7 + PostgreSQL 16 + Redis 7 | 204 个 API 端点
...
- **204 个 API 端点**，覆盖钱包、商户、开放 API、管理后台全场景
- **47 个 Prisma 数据模型**，15 个业务域分组
